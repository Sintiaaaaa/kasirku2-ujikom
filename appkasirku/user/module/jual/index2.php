			...
			<div class="card card-primary">
				<div class="card-header bg-primary text-white">
					...
					<a class="btn btn-danger float-right" 
						onclick="javascript:return confirm('Apakah anda ingin reset keranjang ?');" href="fungsi2/hapus/hapus.php?penjualan=jual">
				...
				<div class="card-body">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<!-- aksi ke table penjualan -->
										<a href="fungsi2/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan'];?>&brg=<?php echo $isi['id_barang'];?>
					...
					<div id="kasirnya">
						<table class="table table-stripped">
							...
							?>
							<!-- aksi ke table nota -->
							<form method="POST" action="index2.php?page=jual&nota=yes#kasirnya">
								<?php foreach($hasil_penjualan as $isi){;?>
								...
								<tr>
									...
									<?php  if(!empty($_GET['nota'] == 'yes')) {?>
										<a class="btn btn-danger" href="fungsi2/hapus/hapus.php?penjualan=jual">
							...
							<tr>
								...
								<td></td>
								<td>
									<a href="print2.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?>
...
$(document).ready(function(){
	$("#cari").change(function(){
		$.ajax({
			type: "POST",
			url: "fungsi2/edit/edit.php?cari_barang=yes",
