        ...
        <!-- <a href="index2.php?page=barang&stok=yes" class="btn btn-warning btn-md mr-2"> -->
            <!-- <i class="fa fa-list"></i> Sortir Stok Kurang</a> -->
        <a href="index2.php?page=barang" class="btn btn-success btn-md">
					...
					?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php }else{?>
                                <a href="index2.php?page=barang/details&barang=<?php echo $isi['id_barang'];?>"><button
