...
<div class="row">
	<div class="col-sm-3">
		<div class="card card-primary">
			...
			<div class="card-footer">
				<form method="POST" action="fungsi2/edit/edit.php?gambar=user" enctype="multipart/form-data">
		...
		<div class="card card-primary">
			...
			<div class="card-body">
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi2/edit/edit.php?profil=edit"
	...
	<div class="col-sm-4">
		<div class="card card-primary">
			...
			<div class="card-body">
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi2/edit/edit.php?pass=ganti-pas">
						<fieldset>
							<div class="control-group mb-3">
